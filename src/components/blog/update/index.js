                ...
                if (response.status === 200) {
                    response.json()
                        .then(result => {
                            this.setState({
                                ...result,
                                selectArticle: result.options.categories.filter(item => item.value == result.categoryId)[0].group
                            })
                        })
                }
                else {
            ...
            <div className="col-md-6">
                <div className="box box-primary">
                    <div className="box-header with-border">
                        ...
                        {
                            (status === 2) ? <span className="active_button" onClick={this.onActiveBlog.bind(this, 1)}>Deactivate</span> : <span className="active_button" onClick={this.onActiveBlog.bind(this, 2)}>Activate</span>
                        }
                    </div>
                    <div className="box-body">
                        ...
                        <div className="select_options">
                            ...
                            <div className={"form-group info"}>
                                ...
                                <DatePicker
                                    selected={moment(this.state.publicDate)}
                        ...
                        <div className="box-footer">
                            <button className="btn btn-primary" onClick={() => this.updateBlog()} >Save</button>
