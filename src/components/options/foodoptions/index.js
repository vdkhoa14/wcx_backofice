...
const validationData = {
    foodOptionName: [notEmpty]
}

export default class FoodOption extends Component {
    ...
    get(param) {
        post("spaOptions/foodOptions/get", param)
            .then(response => {
    ...
    onFoodOptionNameChange(value) {
        this.setState({
            foodOptionName: value
        })
    }
    ...
    onSaveFoodOption() {
        ...
        if (!isValid(validationData))
            return
        let param = {
            "name": this.state.foodOptionName
        }
        post('spaOptions/foodOptions/create', param)
            .then(response => {
                if (response.status === 200) {
    ...
    onUpdateFoodOption() {
        ...
        post("spaOptions/foodOptions/update", param)
            .then((response) => {
                if (response.status === 200) {
    ...
    render() {
        ...
        let { selectedItems, foodOptionName } = this.state
            ...
            <div>
                <div className="box box-primary">
                    <div className="box-header with-border">
                        <h3 className="box-title">Options / FoodOptions</h3>
                        ...
                        <div className="contain">
                            ...
                            <div className="detail">
                                <TextInput
                                    name="foodOptionName"
                                    label="Service name"
                                    value={foodOptionName}
                                    showPlaceholder={false}
                                    validations={validationData.foodOptionName}
                                    onChange={(value) => this.onFoodOptionNameChange(value)}
                                />
                            </div>
                            <div className="footer">
                                <button className="bt_add" onClick={(this.state.isUpdate) ? this.onUpdateFoodOption.bind(this) : this.onSaveFoodOption.bind(this)}>Save</button>
