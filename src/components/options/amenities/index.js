...
export default class Amenity extends Component {
    ...
    get(param) {
        post("spaOptions/amenity/get", param)
            .then(response => {
    ...
    onSaveAmenity() {
        ...
        if (!isValid(validationData))
            return
        let param = {
            "name": this.state.amenityName
        }
        post('spaOptions/amenity/create', param)
            .then(response => {
                if (response.status === 200) {
    ...
    onUpdateAmenity() {
        ...
        post("spaOptions/amenity/update", param)
            .then((response) => {
                if (response.status === 200) {
    ...
    render() {
        ...
        let { selectedItems, amenityName } = this.state
            ...
            <div>
                <div className="box box-primary">
                    <div className="box-header with-border">
                        <h3 className="box-title">Options / Amenities</h3>
                        ...
                        <div className="contain">
                            ...
                            <div className="detail">
                                <TextInput
                                    ...
                                    validations={validationData.amenityName}
                                    onChange={(value) => this.onAmenityNameChange(value)}
                                />
                            </div>
                            <div className="footer">
                                <button className="bt_add" onClick={(this.state.isUpdate) ? this.onUpdateAmenity.bind(this) : this.onSaveAmenity.bind(this)}>Save</button>
